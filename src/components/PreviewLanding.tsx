...
export function PreviewLanding() {
  ...
  return (
    <>
    <div className="relative w-full h-[50vh] md:h-[60vh] lg:h-[70vh] xl:h-[90vh] "><Image src={currentSlide?.image || DEFAULT_IMAGE} alt="swimming" fill className="object-cover"/></div>
