        ...
        <div className="mt-5 rounded-3xl bg-white p-5 shadow-sm">
          ...
          <div className="mt-3 rounded-xl border border-[#7DB7B9] bg-[#E9F4F4] p-4 text-sm">
            ...
            <div className="mt-2 text-gray-700 leading-relaxed">
              ...
              <p className="mt-1">
                ตึกหมาเล็ก {roomsCount.SMALL} ห้อง • ตึกหมาใหญ่{" "}
                {roomsCount.LARGE} ห้อง • VIP {roomsCount.VIP} ห้อง
              </p>
              <p className="mt-1 text-xs text-gray-500">
                ({Math.max(1, nights)} คืน)
              </p>
            </div>
        ...
        <div className="fixed inset-x-0 bottom-16 z-20 bg-[#FFF7EA]/95 backdrop-blur">
          <div className="mx-auto max-w-md px-6 py-4">
            <button
              ...
              disabled={!canConfirm}
              onClick={() => {
                const petsQ = encodeURIComponent(
              ...
              className={`w-full py-4 rounded-2xl text-xl font-bold text-white transition ${
                canConfirm
